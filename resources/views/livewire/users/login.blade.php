    ...
    <div class="container-signin">
        ...
        <form wire:submit.prevent="login">
            <div class="" style="padding-bottom:24px;">
                ...
                <input name="nik" type="text" placeholder="NIK" wire:model="nik" style="border-style:solid; border-width:2px; border-color:#97CBCC;" />
                @error('nik')
        ...
        <div class="logasadmin text-center">
            <p>
               <a href="{{url('/admin/login')}}">Login sebagai admin</a>  <br> Belum punya akun? <a href="{{url('/register')}}">Daftar disini</a>
            </p>
        </div>
